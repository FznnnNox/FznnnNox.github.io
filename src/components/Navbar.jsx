      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between text-sm font-medium">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-full text-gray-600 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors"
            aria-label="Toggle Theme"
          >
            <i
              className={
                isDark ? "ri-sun-line text-lg" : "ri-moon-line text-lg"
              }
            ></i>
          </button>
