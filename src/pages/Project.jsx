...
const Project = () => {
  ...
  // Kita salin array (agar tidak mutasi data asli) lalu urutkan berdasarkan ID terbaru ke atas
      ...
      <section className="px-4 sm:px-6 pb-20">
        <div className="max-w-6xl mx-auto grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className="group relative bg-white dark:bg-[#1c1c1c] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500"
            >
